...
import { getUserRaports, getMyProfile, Raport, API_URL } from "../../utils/api";
import { useTheme } from "../ThemeContext/ThemeContext";
import { SafeAreaView } from "react-native-safe-area-context";

export default function UserRaportsScreen() {
  ...
  useEffect(() => {
    getMyProfile()
      ...
      .catch(e => {
        setUserId(null);
        setCheckedUser(true);
        console.log("Błąd pobierania profilu:", e);
      });
  }, []);
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      setLoading(true);
      getUserRaports(userId)
        .then(data => setRaports(data))
        .catch(e => {
          setRaports([]);
          console.log("Błąd pobierania raportów:", e);
        })
